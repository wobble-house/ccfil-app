...
const quoteImgSrc = `public/Images/Quotes/resident-quote-3.jpg`
...
`
const stickyImageUrl = `public/Images/make-a-difference.jpg`
  ...
  return (
   ...
   <NavHeader description={metadata.description} title={metadata.title} metadata={metadata}/>
        ...
        <Suspense fallback={<Loading/>}>
          ...
          <InfoSegment headerText={headerText} bodyText={bodyText} infoImage={infoImage} ButtonUrl={null} Type="B" icon={'public/Icons/shirt.svg'} id={null}/>
