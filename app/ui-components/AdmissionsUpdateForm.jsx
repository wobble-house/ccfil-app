...
import { getAdmissions } from "../../utils/graphql/queries";
import { updateAdmissions } from "../../utils/graphql/mutations";
const client = generateClient();
export default function AdmissionsUpdateForm(props) {
  const {
    id: idProp,
    admissions: admissionsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = admissionsRecord
      ? { ...initialValues, ...admissionsRecord }
      : initialValues;
    setFirstName(cleanValues.firstName);
    setLastName(cleanValues.lastName);
    setExpectToEnroll(cleanValues.expectToEnroll);
    ...
    setMobilePhone(cleanValues.mobilePhone);
    ...
    setEmergencyContactAddress(cleanValues.emergencyContactAddress);
    setEmergencyContactCity(cleanValues.emergencyContactCity);
    setEmergencyContactState(cleanValues.emergencyContactState);
    setEmergencyContactZip(cleanValues.emergencyContactZip);
    setEmergencyContactFirstName(cleanValues.emergencyContactFirstName);
    setPGSFirstName(cleanValues.PGSFirstName);
    setPGSLastName(cleanValues.PGSLastName);
    setPGSAddress(cleanValues.PGSAddress);
    setPGSHomePhone(cleanValues.PGSHomePhone);
    setEmergencyContactLastName(cleanValues.emergencyContactLastName);
    setPGSEmail(cleanValues.PGSEmail);
    setPGSFax(cleanValues.PGSFax);
    setState(cleanValues.state);
    setPGSSponsor(cleanValues.PGSSponsor);
    setPGSLegalCustody(cleanValues.PGSLegalCustody);
    setPGSPhysicalCustody(cleanValues.PGSPhysicalCustody);
    setPGSEmergencyContact(cleanValues.PGSEmergencyContact);
    setPGSParentGuardian(cleanValues.PGSParentGuardian);
    setPGSRelationship(cleanValues.PGSRelationship);
    setPGSMobilePhone(cleanValues.PGSMobilePhone);
    setPGSWorkPhone(cleanValues.PGSWorkPhone);
    setPGSWorkEmail(cleanValues.PGSWorkEmail);
    setPGSWorkFax(cleanValues.PGSWorkFax);
    setHowDIdYouHearAboutCCFIL(cleanValues.howDIdYouHearAboutCCFIL);
    setReferralSource(cleanValues.referralSource);
    setWhatEventsLeadToSeekTreatment(cleanValues.whatEventsLeadToSeekTreatment);
    setPGSEmployer(cleanValues.PGSEmployer);
    setApplicantsStrengths(cleanValues.applicantsStrengths);
    setApplicantsWeaknesses(cleanValues.applicantsWeaknesses);
    setCurrentPlacementLocation(cleanValues.currentPlacementLocation);
    setCurrentPlacementDates(cleanValues.currentPlacementDates);
    setCurrentPlacementProvider(cleanValues.currentPlacementProvider);
    setPGSJobTitle(cleanValues.PGSJobTitle);
    setPsychAnger(cleanValues.psychAnger);
    setPsychSuicidality(cleanValues.psychSuicidality);
    setPsychSexualActivity(cleanValues.psychSexualActivity);
    setWhatGoalsReceivingTreatment(cleanValues.whatGoalsReceivingTreatment);
    setPsychLegalProblems(cleanValues.psychLegalProblems);
    setMedicalSurgeriesIllnessesHospitalizations(
      cleanValues.medicalSurgeriesIllnessesHospitalizations
    );
    setMedicalPrescriptions(cleanValues.medicalPrescriptions);
    setMedicalVitaminsSupplements(cleanValues.medicalVitaminsSupplements);
    setAllergiesAsthma(cleanValues.allergiesAsthma);
    setInhalerEpiPen(cleanValues.inhalerEpiPen);
    setInhalerType(cleanValues.inhalerType);
    setAutoInsurance(cleanValues.autoInsurance);
    setCurrentPlacementReason(cleanValues.currentPlacementReason);
    setAutoInsuranceClaimNumber(cleanValues.autoInsuranceClaimNumber);
    setPsychSubstanceIssues(cleanValues.psychSubstanceIssues);
    setAutoInsuranceClaimAdjuster(cleanValues.autoInsuranceClaimAdjuster);
    setAutoInsuranceAddress(cleanValues.autoInsuranceAddress);
    setAutoInsuranceCity(cleanValues.autoInsuranceCity);
    setAutoInsuranceState(cleanValues.autoInsuranceState);
    setAutoInsuranceZip(cleanValues.autoInsuranceZip);
    setAutoInsurancePhone(cleanValues.autoInsurancePhone);
    setWorkersCompInsurance(cleanValues.workersCompInsurance);
    setWorkersCompInsuranceCarrier(cleanValues.workersCompInsuranceCarrier);
    setAutoInsuranceDOL(cleanValues.autoInsuranceDOL);
    setWorkersCompClaimAdjuster(cleanValues.workersCompClaimAdjuster);
    setWorkersCompAddress(cleanValues.workersCompAddress);
    setAutoInsuranceCarrier(cleanValues.autoInsuranceCarrier);
    setPGSContactMethod(cleanValues.PGSContactMethod);
    setWorkersCompZip(cleanValues.workersCompZip);
    setWorkersCompPhone(cleanValues.workersCompPhone);
    setWorkersCompClaimNumber(cleanValues.workersCompClaimNumber);
    setWorkersCompCity(cleanValues.workersCompCity);
    setWorkersCompState(cleanValues.workersCompState);
    setErrors({});
  };
  const [admissionsRecord, setAdmissionsRecord] =
    React.useState(admissionsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getAdmissions.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAdmissions
        : admissionsModelProp;
      setAdmissionsRecord(record);
    };
    queryData();
  }, [idProp, admissionsModelProp]);
  React.useEffect(resetStateValues, [admissionsRecord]);
  const validations = {
    firstName: [],
    lastName: [],
    expectToEnroll: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          expectToEnroll: expectToEnroll ?? null,
          ...
          emergencyContactCity: emergencyContactCity ?? null,
          emergencyContactState: emergencyContactState ?? null,
          emergencyContactZip: emergencyContactZip ?? null,
          emergencyContactFirstName: emergencyContactFirstName ?? null,
          PGSFirstName: PGSFirstName ?? null,
          PGSLastName: PGSLastName ?? null,
          PGSAddress: PGSAddress ?? null,
          PGSHomePhone: PGSHomePhone ?? null,
          emergencyContactLastName: emergencyContactLastName ?? null,
          PGSEmail: PGSEmail ?? null,
          PGSFax: PGSFax ?? null,
          state: state ?? null,
          PGSSponsor: PGSSponsor ?? null,
          PGSLegalCustody: PGSLegalCustody ?? null,
          PGSPhysicalCustody: PGSPhysicalCustody ?? null,
          PGSEmergencyContact: PGSEmergencyContact ?? null,
          PGSParentGuardian: PGSParentGuardian ?? null,
          PGSRelationship: PGSRelationship ?? null,
          PGSMobilePhone: PGSMobilePhone ?? null,
          PGSWorkPhone: PGSWorkPhone ?? null,
          PGSWorkEmail: PGSWorkEmail ?? null,
          PGSWorkFax: PGSWorkFax ?? null,
          howDIdYouHearAboutCCFIL: howDIdYouHearAboutCCFIL ?? null,
          referralSource: referralSource ?? null,
          whatEventsLeadToSeekTreatment: whatEventsLeadToSeekTreatment ?? null,
          PGSEmployer: PGSEmployer ?? null,
          applicantsStrengths: applicantsStrengths ?? null,
          applicantsWeaknesses: applicantsWeaknesses ?? null,
          currentPlacementLocation: currentPlacementLocation ?? null,
          currentPlacementDates: currentPlacementDates ?? null,
          currentPlacementProvider: currentPlacementProvider ?? null,
          PGSJobTitle: PGSJobTitle ?? null,
          psychAnger: psychAnger ?? null,
          psychSuicidality: psychSuicidality ?? null,
          psychSexualActivity: psychSexualActivity ?? null,
          whatGoalsReceivingTreatment: whatGoalsReceivingTreatment ?? null,
          psychLegalProblems: psychLegalProblems ?? null,
          medicalSurgeriesIllnessesHospitalizations:
            medicalSurgeriesIllnessesHospitalizations ?? null,
          medicalPrescriptions: medicalPrescriptions ?? null,
          medicalVitaminsSupplements: medicalVitaminsSupplements ?? null,
          allergiesAsthma: allergiesAsthma ?? null,
          inhalerEpiPen: inhalerEpiPen ?? null,
          inhalerType: inhalerType ?? null,
          autoInsurance: autoInsurance ?? null,
          currentPlacementReason: currentPlacementReason ?? null,
          autoInsuranceClaimNumber: autoInsuranceClaimNumber ?? null,
          psychSubstanceIssues: psychSubstanceIssues ?? null,
          autoInsuranceClaimAdjuster: autoInsuranceClaimAdjuster ?? null,
          autoInsuranceAddress: autoInsuranceAddress ?? null,
          autoInsuranceCity: autoInsuranceCity ?? null,
          autoInsuranceState: autoInsuranceState ?? null,
          autoInsuranceZip: autoInsuranceZip ?? null,
          autoInsurancePhone: autoInsurancePhone ?? null,
          workersCompInsurance: workersCompInsurance ?? null,
          workersCompInsuranceCarrier: workersCompInsuranceCarrier ?? null,
          autoInsuranceDOL: autoInsuranceDOL ?? null,
          workersCompClaimAdjuster: workersCompClaimAdjuster ?? null,
          workersCompAddress: workersCompAddress ?? null,
          autoInsuranceCarrier: autoInsuranceCarrier ?? null,
          PGSContactMethod: PGSContactMethod ?? null,
          workersCompZip: workersCompZip ?? null,
          workersCompPhone: workersCompPhone ?? null,
          workersCompClaimNumber: workersCompClaimNumber ?? null,
          workersCompCity: workersCompCity ?? null,
          workersCompState: workersCompState ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateAdmissions.replaceAll("__typename", ""),
            variables: {
              input: {
                id: admissionsRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "AdmissionsUpdateForm")}
      {...rest}
    >
      <TextField
        label="First name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || admissionsModelProp)}
