...
import { createIcon } from "../../utils/graphql/mutations";
export default function IconCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIconTitle(initialValues.iconTitle);
    setErrors({});
  };
  const validations = {
    src: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createIcon.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "IconCreateForm")}
      {...rest}
    >
      <TextField
        label="Src"
