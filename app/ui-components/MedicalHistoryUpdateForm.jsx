...
import { getMedicalHistory } from "../../utils/graphql/queries";
import { updateMedicalHistory } from "../../utils/graphql/mutations";
const client = generateClient();
export default function MedicalHistoryUpdateForm(props) {
  const {
    id: idProp,
    medicalHistory: medicalHistoryModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = medicalHistoryRecord
      ? { ...initialValues, ...medicalHistoryRecord }
      : initialValues;
    setAllergies(cleanValues.allergies);
    setAnaphylacticShock(cleanValues.anaphylacticShock);
    setAnemia(cleanValues.anemia);
    setAnkleProblem(cleanValues.ankleProblem);
    setAnorexiaBulimia(cleanValues.anorexiaBulimia);
    setAppendicitis(cleanValues.appendicitis);
    setArmProblem(cleanValues.armProblem);
    setArthritis(cleanValues.arthritis);
    setAsthma(cleanValues.asthma);
    setBackProblems(cleanValues.backProblems);
    setBedwetting(cleanValues.bedwetting);
    setBladderKidneyProblems(cleanValues.bladderKidneyProblems);
    setBleedingDisorder(cleanValues.bleedingDisorder);
    setBoneCondition(cleanValues.boneCondition);
    setBowelProblems(cleanValues.bowelProblems);
    setBrokenBones(cleanValues.brokenBones);
    setCancer(cleanValues.cancer);
    setChestPains(cleanValues.chestPains);
    setChronicCough(cleanValues.chronicCough);
    setCirculationIssues(cleanValues.circulationIssues);
    setColdsFrequent(cleanValues.coldsFrequent);
    setConstipation(cleanValues.constipation);
    setCystsTumors(cleanValues.cystsTumors);
    setDermatitis(cleanValues.dermatitis);
    setDiabetes(cleanValues.diabetes);
    setDiarrhea(cleanValues.diarrhea);
    setDifficultyWalking(cleanValues.difficultyWalking);
    setEarInfections(cleanValues.earInfections);
    setEndocrineProblems(cleanValues.endocrineProblems);
    setExcessiveSweating(cleanValues.excessiveSweating);
    setFaintingDizziness(cleanValues.faintingDizziness);
    setHeartDisease(cleanValues.heartDisease);
    setFootProblem(cleanValues.footProblem);
    setFrequentColdsSoreThroats(cleanValues.frequentColdsSoreThroats);
    setFrequentHeartburn(cleanValues.frequentHeartburn);
    setFrequentMuscleCramps(cleanValues.frequentMuscleCramps);
    setFrequentShortnessOfBreath(cleanValues.frequentShortnessOfBreath);
    setFrostbite(cleanValues.frostbite);
    setGasBloating(cleanValues.gasBloating);
    setHIVAIDS(cleanValues.HIVAIDS);
    setHeadTraumas(cleanValues.headTraumas);
    setHeadachesMigraines(cleanValues.headachesMigraines);
    setHearingImpairment(cleanValues.hearingImpairment);
    setHeartProblemsMurmurs(cleanValues.heartProblemsMurmurs);
    setHepatitisABC(cleanValues.hepatitisABC);
    setHernia(cleanValues.hernia);
    setHighBloodPressure(cleanValues.highBloodPressure);
    setHypoglycemia(cleanValues.hypoglycemia);
    setIntoleranceToCold(cleanValues.intoleranceToCold);
    setIntoleranceToHeat(cleanValues.intoleranceToHeat);
    setIrregularHeartbeat(cleanValues.irregularHeartbeat);
    setJointInjuries(cleanValues.jointInjuries);
    setKidneyProblems(cleanValues.kidneyProblems);
    setKneeProblem(cleanValues.kneeProblem);
    setLegProblem(cleanValues.legProblem);
    setLiverProblems(cleanValues.liverProblems);
    setLungInfections(cleanValues.lungInfections);
    setMedicalEquipmentDevices(cleanValues.medicalEquipmentDevices);
    setMeningitis(cleanValues.meningitis);
    setMenstrualProblems(cleanValues.menstrualProblems);
    setMononucleosis(cleanValues.mononucleosis);
    setMotionSickness(cleanValues.motionSickness);
    setObesity(cleanValues.obesity);
    setOther(cleanValues.other);
    setPMSSevereSymptoms(cleanValues.PMSSevereSymptoms);
    setPneumoniaBronchitis(cleanValues.pneumoniaBronchitis);
    setPregnancy(cleanValues.pregnancy);
    setRecurrentInjurySurgery(cleanValues.recurrentInjurySurgery);
    setSTDs(cleanValues.STDs);
    setScoliosis(cleanValues.scoliosis);
    setSeizuresEpilepsy(cleanValues.seizuresEpilepsy);
    setShoulderProblem(cleanValues.shoulderProblem);
    setSkinDiseasesProblems(cleanValues.skinDiseasesProblems);
    setSleepwalking(cleanValues.sleepwalking);
    setTBPositive(cleanValues.TBPositive);
    setTBRecentExposure(cleanValues.TBRecentExposure);
    setTuberculosis(cleanValues.tuberculosis);
    setThyroidProblems(cleanValues.thyroidProblems);
    setUlcers(cleanValues.ulcers);
    setUnexpectedWeightLoss(cleanValues.unexpectedWeightLoss);
    setUrinationProblem(cleanValues.urinationProblem);
    setErrors({});
  };
  const [medicalHistoryRecord, setMedicalHistoryRecord] = React.useState(
    medicalHistoryModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getMedicalHistory.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getMedicalHistory
        : medicalHistoryModelProp;
      setMedicalHistoryRecord(record);
    };
    queryData();
  }, [idProp, medicalHistoryModelProp]);
  React.useEffect(resetStateValues, [medicalHistoryRecord]);
  const validations = {
    allergies: [],
    anaphylacticShock: [],
    anemia: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          anaphylacticShock: anaphylacticShock ?? null,
          anemia: anemia ?? null,
          ankleProblem: ankleProblem ?? null,
          anorexiaBulimia: anorexiaBulimia ?? null,
          appendicitis: appendicitis ?? null,
          armProblem: armProblem ?? null,
          arthritis: arthritis ?? null,
          asthma: asthma ?? null,
          backProblems: backProblems ?? null,
          bedwetting: bedwetting ?? null,
          bladderKidneyProblems: bladderKidneyProblems ?? null,
          bleedingDisorder: bleedingDisorder ?? null,
          boneCondition: boneCondition ?? null,
          bowelProblems: bowelProblems ?? null,
          brokenBones: brokenBones ?? null,
          cancer: cancer ?? null,
          chestPains: chestPains ?? null,
          chronicCough: chronicCough ?? null,
          circulationIssues: circulationIssues ?? null,
          coldsFrequent: coldsFrequent ?? null,
          constipation: constipation ?? null,
          cystsTumors: cystsTumors ?? null,
          dermatitis: dermatitis ?? null,
          diabetes: diabetes ?? null,
          diarrhea: diarrhea ?? null,
          difficultyWalking: difficultyWalking ?? null,
          earInfections: earInfections ?? null,
          endocrineProblems: endocrineProblems ?? null,
          excessiveSweating: excessiveSweating ?? null,
          faintingDizziness: faintingDizziness ?? null,
          heartDisease: heartDisease ?? null,
          footProblem: footProblem ?? null,
          frequentColdsSoreThroats: frequentColdsSoreThroats ?? null,
          frequentHeartburn: frequentHeartburn ?? null,
          frequentMuscleCramps: frequentMuscleCramps ?? null,
          frequentShortnessOfBreath: frequentShortnessOfBreath ?? null,
          frostbite: frostbite ?? null,
          gasBloating: gasBloating ?? null,
          HIVAIDS: HIVAIDS ?? null,
          headTraumas: headTraumas ?? null,
          headachesMigraines: headachesMigraines ?? null,
          hearingImpairment: hearingImpairment ?? null,
          heartProblemsMurmurs: heartProblemsMurmurs ?? null,
          hepatitisABC: hepatitisABC ?? null,
          hernia: hernia ?? null,
          highBloodPressure: highBloodPressure ?? null,
          hypoglycemia: hypoglycemia ?? null,
          intoleranceToCold: intoleranceToCold ?? null,
          intoleranceToHeat: intoleranceToHeat ?? null,
          irregularHeartbeat: irregularHeartbeat ?? null,
          jointInjuries: jointInjuries ?? null,
          kidneyProblems: kidneyProblems ?? null,
          kneeProblem: kneeProblem ?? null,
          legProblem: legProblem ?? null,
          liverProblems: liverProblems ?? null,
          lungInfections: lungInfections ?? null,
          medicalEquipmentDevices: medicalEquipmentDevices ?? null,
          meningitis: meningitis ?? null,
          menstrualProblems: menstrualProblems ?? null,
          mononucleosis: mononucleosis ?? null,
          motionSickness: motionSickness ?? null,
          obesity: obesity ?? null,
          other: other ?? null,
          PMSSevereSymptoms: PMSSevereSymptoms ?? null,
          pneumoniaBronchitis: pneumoniaBronchitis ?? null,
          pregnancy: pregnancy ?? null,
          recurrentInjurySurgery: recurrentInjurySurgery ?? null,
          STDs: STDs ?? null,
          scoliosis: scoliosis ?? null,
          seizuresEpilepsy: seizuresEpilepsy ?? null,
          shoulderProblem: shoulderProblem ?? null,
          skinDiseasesProblems: skinDiseasesProblems ?? null,
          sleepwalking: sleepwalking ?? null,
          TBPositive: TBPositive ?? null,
          TBRecentExposure: TBRecentExposure ?? null,
          tuberculosis: tuberculosis ?? null,
          thyroidProblems: thyroidProblems ?? null,
          ulcers: ulcers ?? null,
          unexpectedWeightLoss: unexpectedWeightLoss ?? null,
          urinationProblem: urinationProblem ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateMedicalHistory.replaceAll("__typename", ""),
            variables: {
              input: {
                id: medicalHistoryRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "MedicalHistoryUpdateForm")}
      {...rest}
    >
      <SwitchField
        label="Allergies"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || medicalHistoryModelProp)}
