...
import InsuranceOrderTypeCreateForm from "./InsuranceOrderTypeCreateForm";
import { createMedicalInsurance } from "../../utils/graphql/mutations";
export default function MedicalInsuranceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPolicyholdersFirstName(initialValues.policyholdersFirstName);
    setPolicyholdersLastName(initialValues.policyholdersLastName);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMedicalInsurance.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MedicalInsuranceCreateForm")}
      {...rest}
    >
      <TextField
        label="Company name"
