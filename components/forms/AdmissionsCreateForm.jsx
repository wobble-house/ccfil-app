...
import MedicalHistoryCreateForm from "./MedicalHistoryCreateForm";
import MedicalInsuranceCreateForm from "./MedicalInsuranceCreateForm";
...
export default function AdmissionsCreateForm(props) {
  ...
  return (
    ...
    <form
      ...
      {...rest}
    >
      <h2 className="pb-2">Submit Admissions</h2>
