export default function ReferralsWidget({approved, declined, total}:{approved, declined, total}){
    return(
        <div className='flex flex-col bg-white bg-opacity-75 border-grey-100 pt-2 rounded-lg max-w-xs w-full p-10 mx-auto'>
        <table className="relative inline rounded-lg w-full">
          <tbody className="w-full flex flex-col mx-auto">
          <tr className={`relative grid grid-flow-row grid-cols-2 bg-blue2 text-white items-center justify-between rounded-t-lg`}>
            ...
            <tr className={`grid grid-cols-2 w-full odd:bg-gray-100 even:bg-gray-300 border-b p-2`}>
