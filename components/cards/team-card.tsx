      ...
      >
                  ...
                  onClick={!isModalOpen ? open : close }>
                      ...
                      <div className="absolute px-4 py-2 z-30 w-full bg-blue1 bg-opacity-80 group-hover:bg-opacity-100 align-middle">
                          <h2 className={`relative text-center transform duration-300 delay-100 ease-in-out font-[500] text-white ${(firstName.length + lastName.length > 15) ? 'text-[1.1em] group-hover:text-[1.3em]': 'text-[1.3em] group-hover:text-[1.6em]'}`}>{firstName}&nbsp;{lastName}</h2>
                  ...
                  <div className="flex relative">
                    <HeadshotHandler src={Image.src} alt={Image.alt} fallbackSrc={'public/Images/oof.png'} isCover={true} className="object-cover" />
                  </div>
                  </div>
                </button>
                </li>
